...
def crop_and_send(frame, det, destination = "home/rossis/TEST_CROPS/", name = "test.jpg"):
    det = xywh2xyxy(det)
    for el in det:
        el = el - 40
...
class Opt:
    def __init__(self, weights = 'yolov5s.pt', source = "data/images", img_size = 640, conf_thres =  0.25,
